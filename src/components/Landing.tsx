...
import UserCount from '@/components/merchantCount';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100 flex flex-col items-center justify-center text-center p-6">
      <div className="max-w-4xl">
        ...
        <p className="text-lg md:text-xl text-gray-700 mb-8">
          This portal enables <span className="font-semibold text-purple-600">merchants to register and be verified by Nodal Admins of Organisations</span> based on their region. Nodal Admins and Superadmins have role-based dashboards and control over user verification.
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-center mb-8">
          ...
          <button
            onClick={() => handleLogin("/merchant/login")}
            disabled={loading}
            className={`${
        ...
        <div className="flex flex-row gap-6 justify-center mt-4 text-sm text-gray-700">
          ...
          >
            Login as Nodal Admin <ArrowRight size={16} />
          </button>
          <button
